...
from autoagents.tools import WebBrowserEngineType
...
class WebBrowserEngine:
    def __init__(
        ...
        if engine == WebBrowserEngineType.PLAYWRIGHT:
            module = "autoagents.tools.web_browser_engine_playwright"
            run_func = importlib.import_module(module).PlaywrightWrapper().run
        elif engine == WebBrowserEngineType.SELENIUM:
            module = "autoagents.tools.web_browser_engine_selenium"
